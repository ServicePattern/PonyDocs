...
class PonyDocsTemplate extends QuickTemplate {
	...
	function execute() {
		...
		<script type="text/javascript">
			...
			function AjaxChangeProduct() {
				...
				var title = <?php echo json_encode($this->data['thispage']); ?>;
		...
		<div id="globalWrapper">
				...
				<div class="portlet" id="p-personal">
					...
					<div class="pBody">
						...
						foreach ( $this->data['personal_urls'] as $key => $item ) { ?>
							<li id="<?php echo Sanitizer::escapeId( "pt-$key" ) ?>"
							<?php
							if ( $item['active'] ) { ?>
								class="active"
								<?php
								...
								<a href="<?php echo htmlspecialchars( $item['href'] ) ?>"
									<?php echo Xml::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 'pt-'.$key ) );
									if ( !empty($item['class'] ) ) { ?>
				...
				<div class="portlet" id="p-logo">
					<a style="background-image: url(<?php $this->text( 'logopath' ) ?>);" 
					   href="<?php echo htmlspecialchars( $this->data['nav_urls']['mainpage']['href'] )?>"
						<?php echo Xml::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 'p-logo' ) ) ?>></a><br />
				</div>
			...
			<div id="footer"<?php $this->html( 'userlangattributes' ) ?>>
				...
				$footerlinks = array( 'lastmod', 'viewcount', 'numberofwatchingusers', 'credits', 'copyright', 'privacy', 'about',
					'disclaimer', 'tagline', );
		...
		<div id="p-search" class="portlet">
			...
			<div id="searchBody" class="pBody">
				<form action="<?php $this->text( 'wgScript' ) ?>" id="searchform">
					...
					<?php
					echo Html::input( 'search', isset( $this->data['search'] ) ? $this->data['search'] : '', 'search',
						array(
							'id' => 'searchInput',
					...
					<input type='submit' name="go" class="searchButton" id="searchGoButton"
						   value="<?php $this->msg( 'searcharticle' ) ?>"
							<?php echo Xml::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 'search-go' ) ); ?> />
					<?php
					if ( $wgUseTwoButtonsSearchForm ) { ?>&nbsp;
						...
						<div>
							<a href="<?php $this->text('searchaction') ?>" rel="search">
								<?php $this->msg('powersearch-legend') ?>
							</a>
						</div>
						<?php
					} ?>
					...
					if ( !empty( $this->data['nav_urls']['print']['href'] ) ) { ?>
						<li id="t-print">
							<a href="<?php echo htmlspecialchars( $this->data['nav_urls']['print']['href'] ) ?>" rel="alternate"
								<?php echo Xml::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 't-print' ) ); ?>>
					...
					if( !empty( $this->data['nav_urls']['permalink']['href'] ) ) { ?>
						<li id="t-permalink">
							<a href="<?php echo htmlspecialchars( $this->data['nav_urls']['permalink']['href'] ) ?>"
								<?php echo Xml::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 't-permalink' ) ); ?>>
								<?php $this->msg('permalink') ?>
							</a>
						</li>
						<?php
					} elseif ( $this->data['nav_urls']['permalink']['href'] === '' ) { ?>
						<li id="t-ispermalink"<?php echo Linker::tooltip( 't-ispermalink' ) ?>>
							<?php $this->msg( 'permalink' ) ?>
						</li>
						<?php
					}
	...
	function customBox( $bar, $cont ) { ?>
		<div class='generated-sidebar portlet' id='<?php echo Sanitizer::escapeId( "p-$bar" ) ?>'<?php echo Linker::tooltip('p-'.$bar) ?>>
			<h5>
				<?php
				$out = wfMessage( $bar )->text();
				if ( wfMessage( $bar )->inContentLanguage()->isBlank() ) {
						...
						foreach ( $cont as $key => $val ) { ?>
							<li id="<?php echo Sanitizer::escapeId( $val['id'] ) ?>"
								...
								<a href="<?php echo htmlspecialchars( $val['href'] ) ?>"
									<?php echo Xml::expandAttributes( Linker::tooltipAndAccesskeyAttribs( $val['id'] ) ); ?>>
