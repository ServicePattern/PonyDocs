...
class PonyDocsTOC
{
	...
	/**
	 * The initial PonyDocsVersion instance to which the TOC is created from.
	 * So, for instance, userTOC3.0 would initially be tagged to version 3.0
	 * and then tagged to additional versions through the category interface.
	 *
	 * @var PonyDocsVersion
	 */
	...
	/**
	 * This is the list of versions for which this TOC is tagged for the given manual.
	 * It will include the initial version as well.
	 * They are mapped from version name to actual PonyDocsVersion instance.
	 *
	 * @var array 
	 */
	...
	public function __construct( 
		PonyDocsProductManual& $pManual, PonyDocsProductVersion& $initialVersion, PonyDocsProduct& $product ) {
	 ...
	 * This should strip strange characters (which?) and convert spaces to underscores,
	 * which is slightly different than normalizing a topic name.
	 *
	 * @static
